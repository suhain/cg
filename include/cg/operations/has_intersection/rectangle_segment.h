...
namespace cg
{
    ...
    bool has_intersection(rectangle_2t<Scalar> const &r,
                          segment_2t<Scalar> const   &s)
    {
        return r.contains(s[0]) || has_intersection(segment_2t<Scalar>(r.corner(0, 0), r.corner(0, 1)), s)
