...
namespace cg
{
    ...
    struct triangle_2t
    {
        ...
        point_2t<Scalar> & operator [] (size_t id)
        {
            return pts_[id];
        }
        point_2t<Scalar> const & operator [] (size_t id) const
        {
            return pts_[id];
        }

        segment_2t<Scalar> side(size_t id) const
        {
            return segment_2t<Scalar>(pts_[(id + 1) % 3], pts_[(id + 2) % 3]);
        }
