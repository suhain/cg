...
struct triangle_contains_point_viewer:
    cg::visualization::viewer_adapter
{
    ...
    {
        p.corner_stream() << "press mouse rbutton near triangle vertex to move it" << cg::visualization::endl
                          << "if triangle is green triangle contains cursor point" << cg::visualization::endl;
    }
